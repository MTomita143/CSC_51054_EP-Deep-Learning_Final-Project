# src/models/camembert_xgb_meta_pca.py
import os
import numpy as np
import torch
...
def build_pipeline(num_columns, bool_columns, list_columns, unuseful_columns, n_estimators=1000, max_depth=9, pca_components=128):
